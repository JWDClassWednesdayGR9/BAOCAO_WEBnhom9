    ...
    <div class="row">
      <div class="col-md-3" style="padding-left: 50px;padding-top: 10px">
           <ul class="nav nav-pills nav-stacked" style="background-color: #DDDDDD">
            ...
            <li class="active"><a href="sv_ttDeTai.jsp" target="_parent" >Thông tin đề tài</a></li>
            <li role="presentation"><a href="sv_ttGiangVien.jsp" target="_parent" >Thông tin giảng viên</a></li>
          </ul>
      </div>
      <div class="col-md-9">  
          <form class="ttkl">
