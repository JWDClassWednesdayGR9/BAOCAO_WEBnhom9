...
<div class="panel panel-default">
    ...
    <div class="menutop">
        <ul class="menu">
          <li>
          <a href="dsdsPhongtrong.jsp">Trở về</a>
          </li>
        </ul>
    </div>
</div>
          ...
          <form class="form-horizontal">
				  ...
				  <div class="form-group"> 
				    <div class="col-sm-offset-6 col-sm-10">
				      ...
				      <a href="themphongtrong.jsp" type="reset" class="btn btn-primary btn-sm">Hủy</a>
				      <a href="dsPhongtrong.jsp" type="submit" class="btn btn-primary btn-sm">Đồng ý</a>
				    </div>
				  </div>
          </form>
          </div>
