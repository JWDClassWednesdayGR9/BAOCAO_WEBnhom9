    ...
    <div class="row">
      <div class="col-md-3" style="padding-left: 50px;padding-top: 33px">
           <ul class="nav nav-pills nav-stacked" style="background-color: #DDDDDD">
            ...
            <li class="active"><a href="ThongtinKhoaLuan.jsp" target="_parent" >Thông tin khóa luận</a></li>
              ...
              <div>
                    <table width="900" border="2" cellspacing="2" cellpadding="2">
                      <tr bgcolor="lightblue">
                        ...
                        <th style="color: #0000FF;font: bold;font-size: 18px;text-align: center" width="267" scope="col">Bộ môn</th>
                      </tr>
                    </table>
              </div>
