...
/**
 * Servlet implementation class InsertDT
 */
@WebServlet("/InsertDT")
public class InsertDT extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
	    ...
	    String err ="";
	    if(maDT.equals("")|| tenDT.equals("")|| maGV.equals("") || maSV.equals("") || chuyenNganh.equals("")){
		...
		RequestDispatcher rd=request.getRequestDispatcher("/trk_themdetai.jsp");
