          ...
          <div class="ttgv">
              ...
              <div>
                  <table width="900" border="2" cellspacing="2" cellpadding="2">
                    <tr bgcolor="lightblue" align="center">
                      ...
                      <th style="color: #0000FF;font: bold;font-size: 18px;text-align: center" width="180" scope="col">Email</th>
                    </tr>
                  </table>
              </div>
              <div class="table" id="klTable" style="width:900px;height:180px;overflow:auto;" align="center">
                    <table width="900" height="228" border="2" cellpadding="2" cellspacing="2" style="text-align: center">
                      <%
				ResultSet ds = (ResultSet)request.getAttribute("rs");
				while (ds.next()) {
			%>
                      <tr>
                        <td width="178"><%=ds.getString("tenSV") %></td>
                        <td width="110"><%=ds.getString("maSV") %></td>
                        <td width="210"><%=ds.getString("Khoa") %></td>
                        <td width="176"><%=ds.getString("chuyenNganh") %></td>
                        <td width="180"><%=ds.getString("email") %></td>
                      </tr>
                      <%} %>
                    </table>
              </div>
