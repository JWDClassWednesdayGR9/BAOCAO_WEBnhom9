    ...
    <div class="row">
      <div class="col-md-3" style="padding-left: 50px;padding-top: 33px">
           <ul class="nav nav-pills nav-stacked" style="background-color: #DDDDDD">
            ...
            <li class="active"><a href="DanhSachPhongTrong" target="_parent" >Danh sách phòng trống</a></li>
            <li role="presentation"><a href="QLyTaiKhoan" target="_parent" >Quản lý tài khoản</a></li>
          </ul>
      </div>
      <div class="col-md-9">  
          <form class="ttkl">
              <div class="kltitle" align="center" style="font-size: 20px"><label>Danh sách phòng trống</label>
              </div>
              <div>
                    <table width="900" border="2" cellspacing="2" cellpadding="2">
                      <tr bgcolor="lightblue">
                        <th style="color: #0000FF;font: bold;font-size: 18px;text-align: center" width="270" scope="col">Ngày</th>
                        <th style="color: #0000FF;font: bold;font-size: 18px;text-align: center" width="300" scope="col">Phòng</th>
                        <th style="color: #0000FF;font: bold;font-size: 18px;text-align: center" width="267" scope="col">Thời gian</th>
                      </tr>
                    </table>
              </div>
			...
			%>
                      <tr>
                        <td width="270"><%=ds.getString("Ngay") %></td>
                        <td width="300"><%=ds.getString("tenPhong") %></td>
                        <td width="267"><%=ds.getString("Gio") %></td>
                      </tr>
                      <%} %>
                    </table>
              </div>
              <div style="float: right">
              		<a href="themphongtrong.jsp" type="button" class="btn btn-primary btn-sm">Thêm</a>
