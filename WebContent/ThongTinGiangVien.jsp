    ...
    <div class="row">
      <div class="col-md-3" style="padding-left: 50px;padding-top: 33px">
           <ul class="nav nav-pills nav-stacked" style="background-color: #DDDDDD">
            ...
            <li class="active"><a href="ThongTinGiangVien" target="_parent" >Thông tin giảng viên</a></li>
          ...
          <div class="ttgv">
			...
			%>
              ...
              <div style="float: right">
              		<a href="trk_themgiangvien.jsp" type="button" class="btn btn-primary btn-sm">Thêm</a>
              		<!-- <a type="button" class="btn btn-primary btn-sm">Sửa</a> -->
              		<!-- <a type="button" class="btn btn-primary btn-sm">Xóa</a> --><!--<a type="button" class="btn btn-primary btn-sm">Xóa</a>  -->
