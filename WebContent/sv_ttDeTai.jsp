    ...
    <div class="row">
      <div class="col-md-3" style="padding-left: 50px;padding-top: 10px">
           <ul class="nav nav-pills nav-stacked" style="background-color: #DDDDDD">
            ...
            <li class="active"><a href="ThongTinDeTaiSV" target="_parent" >Thông tin đề tài</a></li>
            <li role="presentation"><a href="ThongTinGV_SV" target="_parent" >Thông tin giảng viên</a></li>
          </ul>
      </div>
      <div class="col-md-9">  
          <form class="ttkl">
              ...
              <div>
                    <table width="900" border="2" cellspacing="2" cellpadding="2">
                      <tr bgcolor="lightblue">
                        ...
                        <th style="color: #0000FF;font: bold;font-size: 18px;text-align: center" width="267" scope="col">Mã Số SV</th>
                      </tr>
                    </table>
              </div>
