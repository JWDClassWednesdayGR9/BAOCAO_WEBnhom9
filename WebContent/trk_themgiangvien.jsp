...
<div class="panel panel-default">
    ...
    <div class="menutop">
        <ul class="menu">
          <li>
          <a href="ThongTinGiangVien">Trở về</a>
          </li>
        </ul>
    </div>
</div>
<div class="container">
    <div class="row">
      <div class="col-md-7 col-md-offset-3" style="padding-top: 30px">  
          ...
          <form class="form-horizontal"  method="post" action="ThemGV">
          <div class="form-group">
          		<label class="control-label col-sm-4" for="text">Mã Giảng Viên:</label>
				    <div class="col-sm-8">
				      <input name="maGV" type="text" class="form-control" id="ten" placeholder="nhập mã GV">
				    </div>
				  </div>
          	    <div class="form-group">
				  ...
				  <div class="form-group">
				    ...
				    <div class="col-sm-8"> 
				      <input name="hocVi" type="text" class="form-control" id="hocvi" placeholder=" nhập học vị">
				    </div>
				  </div>
				  <div class="form-group">
				  <label class="control-label col-sm-4" for="text">Email:</label>
				    <div class="col-sm-8">
				      <input name="email" type="text" class="form-control" id="ten" placeholder="nhập email">
				    </div>
				  </div>
				  <div class="form-group">
				  <label class="control-label col-sm-4" for="text">SĐT:</label>
				    <div class="col-sm-8">
				      <input name="SDT" type="text" class="form-control" id="ten" placeholder="nhập SĐT">
				    </div>
				  </div>
				  <div class="form-group">
				    <label class="control-label col-sm-4" for="text">Chức vụ:</label>
				    <div class="col-sm-8"> 
				      <input name="vaiTro" type="text" class="form-control" id="chucvu" placeholder=" nhập chức vụ">
				    </div>
				  </div>
				  <div class="form-group">
				    <label class="control-label col-sm-4" for="text">Đơn vị công tác:</label>
				    <div class="col-sm-8"> 
				      <input name="donviCT" type="text" class="form-control" id="donvi" placeholder=" nhập đơn vị công tác ">
				    </div>
				  </div>
				  ...
				  <div class="form-group">
				    ...
				    <div class="col-sm-8"> 
				      <input name="boMon" type="text" class="form-control" id="bomon" placeholder=" nhập bộ môn giảng dạy">
				    </div>
				  </div>				  
				  <div class="form-group"> 
				    <div class="col-sm-offset-6 col-sm-10">
				      <input type="submit" id="themgv"  value="Submit" class="btn btn-primary btn-sm" background-color: blue">
