              ...
              <div class="hdtitle" align="center" style="font-size: 20px"><label>Thông tin hội đồng</label>
                    ...
                    <table width="900" border="2" cellspacing="2" cellpadding="2">
                      <tr bgcolor="lightblue">
                        ...
                        <th style="color: #0000FF;font: bold;font-size: 18px;text-align: center" width="130" scope="col">Thời gian bảo vệ</th>
                        <th style="color: #0000FF;font: bold;font-size: 18px;text-align: center" width="140" scope="col">Địa Điểm</th>
                    ...
                    <%
				ResultSet ds = (ResultSet)request.getAttribute("danhsac");
				while (ds.next()) {
			%>
                      <tr>
                        ...
                        <td width="140"><%=ds.getString("diaDiem") %></td>
